    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden" style={{ height: '100%' }}>
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-2 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">Contas a Pagar</p>
        </div>
        <Link href="/financeiro/contas-a-pagar" className="text-xs text-blue-500 hover:text-blue-700 flex items-center gap-1">
      ...
      <div className="flex-1 flex flex-col px-4 pb-4 gap-2 min-h-0">
        ...
        {/* Total em aberto */}
        <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl px-4 py-3 text-center">
          <p className="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-0.5">Total em Aberto</p>
          <p className="text-2xl font-black text-orange-700 dark:text-orange-400">{fmt(aPagar)}</p>
        ...
        <Link href="/financeiro/contas-a-pagar?status=VENCIDO"
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-slate-500">{aPagarVencidosQtd} conta{aPagarVencidosQtd !== 1 ? 's' : ''}</p>
            </div>
          </div>
        ...
        {/* No prazo */}
        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl px-4 py-2.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <CreditCard className="w-3.5 h-3.5 text-amber-500 shrink-0" />
            <div>
              <p className="text-xs font-semibold text-amber-700 dark:text-amber-400">No prazo</p>
              <p className="text-xs text-gray-400 dark:text-slate-500">{emDiaQtd} conta{emDiaQtd !== 1 ? 's' : ''}</p>
            </div>
          </div>
          <p className="text-base font-black text-amber-600 dark:text-amber-400">{fmt(emDia)}</p>
        </div>
