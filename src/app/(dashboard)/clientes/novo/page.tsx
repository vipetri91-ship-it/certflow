          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {tipo === 'PF' ? (
                ...
                <>
                  <Campo label="CNPJ">
                    <Input value={form.cnpj} onChange={e => set('cnpj', formatarCNPJ(e.target.value))} placeholder="00.000.000/0000-00" maxLength={18} />
                  </Campo>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              <Campo label="CEP">
                <div className="relative">
                  <Input
                    value={form.cep}
                    onChange={e => { const v = formatarCEP(e.target.value); set('cep', v); if (v.replace(/\D/g,'').length === 8) buscarCep(v) }}
                    placeholder="00000-000"
                    maxLength={9}
                  />
                  {buscandoCep && <span className="absolute right-2 top-2 text-xs text-gray-400">Buscando...</span>}
                </div>
              </Campo>
