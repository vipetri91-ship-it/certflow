    ...
    try {
      ...
      const body = {
        ...
        clienteDados: {
          ...
          cpf:           dados.tipoPessoa === 'PF' ? dados.cpf.replace(/\D/g,'') : dados.cpfResponsavel.replace(/\D/g,''),
          ...
          email:         isPJ ? (dados.emailEmpresa || dados.email) : dados.email,
          ddd:           dados.ddd,
          celular:       dados.ddd + dados.telefone.replace(/\D/g,''),
          dataNascimento: dados.tipoPessoa === 'PF' ? dados.dataNascimento : dados.dataNasc || undefined,
